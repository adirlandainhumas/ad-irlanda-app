        ...
        <div className="nt-content">
          ...
          <div style={{
            ...
            <div style={{ display:"flex", alignItems:"center", gap:10, position:"relative", zIndex:1 }}>
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/aogiminhumas"
                target="_blank"
                ...
                style={{
                  ...
                  textDecoration:"none",
                  boxShadow:"0 4px 16px rgba(130,50,180,.3)",
              ...
              {/* YouTube */}
              <a
                href="https://www.youtube.com/channel/UCZSKJY1tWNQHyEE3vO0y4wQ"
                target="_blank"
                rel="noopener noreferrer"
                style={{
                  display:"inline-flex", alignItems:"center", gap:7,
                  ...
                  padding:"8px 14px", borderRadius:999,
                  textDecoration:"none",
                  boxShadow:"0 4px 16px rgba(255,0,0,.25)",
                  transition:"transform .18s, box-shadow .18s",
                }}
                onMouseEnter={e => { (e.currentTarget as HTMLAnchorElement).style.transform="translateY(-2px)"; }}
                onMouseLeave={e => { (e.currentTarget as HTMLAnchorElement).style.transform="translateY(0)"; }}
              ...
              {/* TikTok */}
              <a
                href="https://www.tiktok.com/@ad.irlanda.inhumas"
                target="_blank"
                rel="noopener noreferrer"
                style={{
                  display:"inline-flex", alignItems:"center", gap:7,
