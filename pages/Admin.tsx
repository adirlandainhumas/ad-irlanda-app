                      ...
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {pr.contato && (
                          <a
                            ...
                            className="text-xs text-blue-700 underline underline-offset-2 hover:text-blue-900 transition font-medium flex items-center gap-1"
                          >
                            {pr.contato.match(/^\d/) ? (
                              <svg viewBox="0 0 24 24" fill="currentColor" className="w-3 h-3 flex-shrink-0">
                                ...
                                <path d="M12 0C5.373 0 0 5.373 0 12c0 2.127.558 4.122 1.532 5.848L.073 23.633a.5.5 0 00.612.612l5.785-1.459A11.945 11.945 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 22c-1.893 0-3.667-.524-5.178-1.432l-.37-.223-3.836.968.968-3.836-.223-.37A9.945 9.945 0 012 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z"/>
                              </svg>
                            ) : (
